...
PASSIVE = 'TrialM68_10_8';
AGGRESSIVE = 'TrialM68_3_2';
FRONT = 'front_dist';
...
grid on;
xlim([0,2700]);
plot(original(1:interval:1000,1),front(1:interval:1000,2),'*-','Linewidth',1.5)
...
ylabel('Front distance (m)','Fontsize',12);
...
xlim([0,2700]);
ylim([15,35]);
plot(original(1:interval:1000,1),original(1:interval:1000,4),'*-','Linewidth',1.5)
plot(passive(1:interval:1000,1),passive(1:interval:1000,4),'o-','Linewidth',1.5)
