...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _sample_action(
        ...
        if self.num_timesteps < learning_starts and not (self.use_sde and self.use_sde_at_warmup)\
                or not (self.replay_buffer0.pos >= 100 and self.replay_buffer1.pos >= 100 and self.replay_buffer2.pos >= 100):
            # Warmup phase
...
class TD3_ver1(OffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(TD3_ver1, self)._setup_model()
    ...
    def learn(
        ...
        return super(TD3_ver1, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(TD3_ver1, self)._excluded_save_params() + ["actor", "critic", "actor_target", "critic_target","replay_buffer0","replay_buffer1","replay_buffer2"]
