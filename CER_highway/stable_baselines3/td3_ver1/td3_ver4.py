...
class TD3_ver4(OffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(TD3_ver4, self)._setup_model()
    ...
    def learn(
        ...
        return super(TD3_ver4, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(TD3_ver4, self)._excluded_save_params() + ["actor", "critic", "actor_target", "critic_target",
