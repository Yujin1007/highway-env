...
class TD3Policy(BasePolicy):
    ...
    def __init__(
        ...
        if net_arch is None:
            if features_extractor_class == NatureCNN or features_extractor_class == CustomCombinedExtractor:
                net_arch = []
            else:
                net_arch = [400, 300]
...
register_policy("CustomMultiInputPolicy", CustomMultiInputPolicy)
